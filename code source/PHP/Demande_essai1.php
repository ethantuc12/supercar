...
if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO demande (idinscription, nom, prenom, email, Id_Voiture, marque, modele, details, date1, heure1, Status1)
    VALUES ('$idinscription','$nom', '$prenom', '$email','$idVoiture', '$marqueFromDB', '$modeleFromDB', '$details', '$date1', '$heure1','En cours')";
